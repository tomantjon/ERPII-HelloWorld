		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#helloworldhogentcomhelloworld-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"helloworldhogentcomhelloworld-display": {
								"semanticObject": "helloworldhogentcomhelloworld",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=helloworld.hogent.com.helloworld",
									"url": sap.ui.require.toUrl("helloworld/hogent/com/helloworld")
								}
							}
						}
					}
